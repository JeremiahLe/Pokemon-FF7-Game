...
public class CreateMonster : MonoBehaviour
{
    ...
    public List<AffinityClass> listOfElementImmunities;
        ...
        if (statEnumToChange == AttackEffect.StatToChange.Immunity)
        {
            ...
            switch (modifier.attackEffect.immunityType)
            {
                case AttackEffect.ImmunityType.Element:
                    newStatusEffectIcon.modifier.modifierDescription = ($"{modifier.attackEffect.affinityImmunity.affinityType.ToString()} Element Immunity");
                    break;
