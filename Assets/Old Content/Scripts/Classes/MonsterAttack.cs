...
public class MonsterAttack : ScriptableObject
{
    ...
    public AffinityClass.AffinityType monsterAttackElement;
    [FormerlySerializedAs("monsterElementClass")] public AffinityClass monsterAffinityClass;
    ...
    public MonsterAttack(string _monsterAttackName, AffinityClass affinityClass, MonsterAttackDamageType _damageType, float _monsterAttackMultiplier, float _monsterAttackDamageScalar, Monster _monsterAttackSource, GameObject _monsterAttackSourceGameObject)
    {
        monsterAttackName = _monsterAttackName;

        monsterAffinityClass = affinityClass;
