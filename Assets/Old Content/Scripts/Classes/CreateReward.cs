...
public class CreateReward : MonoBehaviour, IPointerClickHandler
{
    ...
    public void InitializeMonsterSelectCardData(Monster monster)
    {
        ...
        monsterSelectCardBase.color = GetElementColor(monsterReward.monsterAffinity);
    }

    public Color32 GetElementColor(AffinityClass affinity)
    {
        switch (affinity.affinityType)
        {
            // case AffinityClass.AffinityType.Fire:
            //     return fireColor;
            // case AffinityClass.AffinityType.Water:
            //     return waterColor;
            // case AffinityClass.AffinityType.Earth:
            //     return earthColor;
            // case AffinityClass.AffinityType.Wind:
            //     return windColor;
            // case AffinityClass.AffinityType.Shadow:
            //     return shadowColor;
            // case AffinityClass.AffinityType.Neutral:
            //     return Color.gray;
            // case AffinityClass.AffinityType.None:
            //     return Color.gray;
            // case AffinityClass.AffinityType.Light:
            //     return lightColor;
            // case AffinityClass.AffinityType.Time:
            //     return timeColor;
            // case AffinityClass.AffinityType.Elixir:
            //     return elixirColor;
            // case AffinityClass.AffinityType.Electric:
            //     return electricColor;
            // case AffinityClass.AffinityType.Stone:
            //     return stoneColor;
            // case AffinityClass.AffinityType.Sound:
            //     return soundColor;
            default:
                return Color.gray;
        }
