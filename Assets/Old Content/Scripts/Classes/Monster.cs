...
public class Monster : ScriptableObject
{
    ...
    [FormerlySerializedAs("monsterElement")] [Title("Setup")]
    public AffinityClass monsterAffinity;
    [FormerlySerializedAs("monsterSubElement")] public AffinityClass monsterSubAffinity;
