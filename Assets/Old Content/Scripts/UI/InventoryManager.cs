...
public class InventoryManager : MonoBehaviour
{
    ...
    public void InitializeAscensionWindow()
    {
        ...
        // if (currentMonster.monsterSubAffinity.element != AffinityClass.AffinityType.None)
        // {
        //     monsterElementsText.text =
        //         ($"<b>Elements</b>" +
        //         $"\n{currentMonster.monsterAffinity.element} / {currentMonster.monsterSubAffinity.element}");
        // }
        // else
        // {
        //     monsterElementsText.text =
        //         ($"<b>Element</b>" +
        //         $"\n{currentMonster.monsterAffinity.element}");
        // }
    ...
    public void InitializeConfirmAscensionWindow(int ascensionNumber)
    {
        ...
        monsterNewCommand.GetComponent<Interactable>().interactableName = ($"{currentAscensionPath.monsterAscensionAttack.monsterAttackName} ({currentAscensionPath.monsterAscensionAttack.monsterAffinityClass.affinityType}, {currentAscensionPath.monsterAscensionAttack.monsterAttackDamageType})");
        ...
        // if (currentAscensionPath.monsterSubAffinity.element != AffinityClass.AffinityType.None)
        // {
        //     monsterAscensionCheckAscensionText.text += ($"\n{currentAscensionPath.monsterAffinity.element} / {currentAscensionPath.monsterSubAffinity.element}");
        // }
        // else
        // {
        //     monsterAscensionCheckAscensionText.text += ($"\n{currentAscensionPath.monsterAffinity.element}");
        // }
    ...
    public void ShowAscendedMonsterWindow()
    {
        ...
        newAttackHolder.GetComponentInChildren<TextMeshProUGUI>().text =
            ...
            $"\nElement: {newAttackHolder.monsterAttackReference.monsterAffinityClass.affinityType.ToString()} | Type: {newAttackHolder.monsterAttackReference.monsterAttackDamageType}");
        ...
        foreach (GameObject monsterAttackHolder in monsterAscendedAttackHolders)
        {
            ...
            dragController.GetComponentInChildren<TextMeshProUGUI>().text =
                ...
                $"\nElement: {dragController.monsterAttackReference.monsterAffinityClass.affinityType.ToString()} | Type: {dragController.monsterAttackReference.monsterAttackDamageType}");
